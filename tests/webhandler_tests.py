...
class function_webhandler_verify_url_is_alive(unittest.TestCase):
	...
	def test_existng_webpages(self):
		self.assertEqual(WH.webhandler_verify_url_is_alive('https://www.google.com/'), True)
		self.assertEqual(WH.webhandler_verify_url_is_alive('http://www.google.com/'), True)
		self.assertEqual(WH.webhandler_verify_url_is_alive('http://www.google.com'), True)

	def test_non_existing_webpages(self):
		self.assertEqual(WH.webhandler_verify_url_is_alive('http://www.nonexistingwebpage111'), False)
